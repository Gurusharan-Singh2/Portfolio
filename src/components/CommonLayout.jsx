...
const CommonLayout = ({ children }) => {
  ...
  return (
    ...
    <div key={pathname} className="max-w-screen min-h-screen h-auto  bg-gradient-to-b from-blue-200 to-violet-200 dark:bg-none dark:bg-zinc-900">
      <motion.div className='h-screen w-screen fixed bg-black dark:bg-white rounded-b-[100px] z-40 pointer-events-none'
      animate={{height:"0vh"}} 
      exit={{
        height:"140vh"
      }}
    ...
    {pathname.substring(1).toUpperCase()}
      ...
      <motion.div className='h-screen w-screen fixed bg-black dark:bg-white rounded-t-[100px] bottom-0 z-30 pointer-events-none'
